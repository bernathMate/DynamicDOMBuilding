...
function createUsersTableBody(users) {
    ...
    for (let i = 0; i < users.length; i++) {
        ...
        const buttonElAlbums = document.createElement('button');
        buttonElAlbums.textContent = 'Albums';
        buttonElAlbums.setAttributeNode(userIdAttr);
        buttonElAlbums.addEventListener('click', onLoadAlbums);

        const albumsTdEl = document.createElement('td');
        albumsTdEl.appendChild(buttonElAlbums);
